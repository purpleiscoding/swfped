package org.papervision3d.core.proto
{
   ...
   public class GeometryObject3D extends EventDispatcher
   {
      ...
      public function transformVertices(param1:Matrix3D) : void
      {
         ...
         _loc12_ = param1.n24;
         _loc13_ = param1.n34;
         _loc14_ = int(vertices.length);
         while(true)
         {
            _loc15_ = vertices[--_loc14_];
            if(!_loc15_)
            {
               break;
            }
      ...
      public function transformUV(param1:MaterialObject3D) : void
      {
         var _loc2_:String = null;
         if(param1.bitmap)
         {
            for(_loc2_ in this.faces)
            {
               faces[_loc2_].transformUV(param1);
            }
         }
      }
      ...
      public function clone(param1:DisplayObject3D = null) : GeometryObject3D
      {
         ...
         var _loc4_:GeometryObject3D = null;
         var _loc5_:int = 0;
         ...
         _loc4_ = new GeometryObject3D();
         _loc4_.vertices = new Array();
