package org.papervision3d.core.math
{
   public class Quaternion
   {
      ...
      public static function createFromMatrix(param1:Matrix3D) : Quaternion
      {
         ...
         _loc4_ = new Array(4);
         _loc8_ = param1.n11 + param1.n22 + param1.n33;
         if(_loc8_ > 0)
         {
      ...
      public static function createFromAxisAngle(param1:Number, param2:Number, param3:Number, param4:Number) : Quaternion
      {
         ...
         _loc5_.setFromAxisAngle(param1,param2,param3,param4);
         return _loc5_;
      }
      ...
      public static function slerp(param1:Quaternion, param2:Quaternion, param3:Number) : Quaternion
      {
         ...
         var _loc7_:Number = NaN;
         var _loc8_:Number = NaN;
         _loc4_ = param1.w * param2.w + param1.x * param2.x + param1.y * param2.y + param1.z * param2.z;
         if(_loc4_ < 0)
         {
            param1.x *= -1;
            param1.y *= -1;
      ...
      public static function createFromOrthoMatrix(param1:Matrix3D) : Quaternion
      {
         ...
         _loc2_.x = param1.n32 - param1.n23 < 0 ? (_loc2_.x < 0 ? _loc2_.x : -_loc2_.x) : (_loc2_.x < 0 ? -_loc2_.x : _loc2_.x);
         _loc2_.y = param1.n13 - param1.n31 < 0 ? (_loc2_.y < 0 ? _loc2_.y : -_loc2_.y) : (_loc2_.y < 0 ? -_loc2_.y : _loc2_.y);
         _loc2_.z = param1.n21 - param1.n12 < 0 ? (_loc2_.z < 0 ? _loc2_.z : -_loc2_.z) : (_loc2_.z < 0 ? -_loc2_.z : _loc2_.z);
         return _loc2_;
      }
      ...
      public static function slerpOld(param1:Quaternion, param2:Quaternion, param3:Number) : Quaternion
      {
         ...
         _loc5_ = param1.w * param2.w + param1.x * param2.x + param1.y * param2.y + param1.z * param2.z;
         ...
         _loc7_ = Math.sqrt(1 - _loc5_ * _loc5_);
         ...
         _loc9_ = Math.sin(param3 * _loc6_) / _loc7_;
      ...
      public function get matrix() : Matrix3D
      {
         ...
         _loc8_ = z * z;
         _loc9_ = z * w;
         _matrix.n11 = 1 - 2 * (_loc5_ + _loc8_);
         _matrix.n12 = 2 * (_loc2_ - _loc9_);
         _matrix.n13 = 2 * (_loc3_ + _loc7_);
         _matrix.n21 = 2 * (_loc2_ + _loc9_);
         _matrix.n22 = 1 - 2 * (_loc1_ + _loc8_);
         _matrix.n23 = 2 * (_loc6_ - _loc4_);
         _matrix.n31 = 2 * (_loc3_ - _loc7_);
         _matrix.n32 = 2 * (_loc6_ + _loc4_);
         _matrix.n33 = 1 - 2 * (_loc1_ + _loc5_);
         return _matrix;
      }
      ...
      public function toEuler() : Number3D
      {
         ...
         _loc1_ = new Number3D();
         _loc2_ = this;
         _loc3_ = _loc2_.x * _loc2_.y + _loc2_.z * _loc2_.w;
         if(_loc3_ > 0.499)
         {
         ...
         _loc4_ = _loc2_.x * _loc2_.x;
         _loc5_ = _loc2_.y * _loc2_.y;
         _loc6_ = _loc2_.z * _loc2_.z;
      ...
      public function mult(param1:Quaternion) : void
      {
         ...
         _loc4_ = this.y;
         _loc5_ = this.z;
         x = _loc2_ * param1.x + _loc3_ * param1.w + _loc4_ * param1.z - _loc5_ * param1.y;
         y = _loc2_ * param1.y - _loc3_ * param1.z + _loc4_ * param1.w + _loc5_ * param1.x;
         z = _loc2_ * param1.z + _loc3_ * param1.y - _loc4_ * param1.x + _loc5_ * param1.w;
         w = _loc2_ * param1.w - _loc3_ * param1.x - _loc4_ * param1.y - _loc5_ * param1.z;
      }
   }
}
