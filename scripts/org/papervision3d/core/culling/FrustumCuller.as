package org.papervision3d.core.culling
{
   ...
   public class FrustumCuller implements IObjectCuller
   {
      ...
      public function pointInFrustum(param1:Number, param2:Number, param3:Number) : int
      {
         ...
         _loc5_ = param1 - _loc4_.n14;
         _loc6_ = param2 - _loc4_.n24;
         _loc7_ = param3 - _loc4_.n34;
         _loc8_ = _loc5_ * _loc4_.n13 + _loc6_ * _loc4_.n23 + _loc7_ * _loc4_.n33;
         if(_loc8_ > _far || _loc8_ < _near)
         {
            return OUTSIDE;
         }
         _loc9_ = _loc5_ * _loc4_.n12 + _loc6_ * _loc4_.n22 + _loc7_ * _loc4_.n32;
         _loc10_ = _loc8_ * _tang;
         if(_loc9_ > _loc10_ || _loc9_ < -_loc10_)
         {
            return OUTSIDE;
         }
         _loc11_ = _loc5_ * _loc4_.n11 + _loc6_ * _loc4_.n21 + _loc7_ * _loc4_.n31;
         _loc10_ *= _ratio;
      ...
      public function initialize(param1:Number = 60, param2:Number = 1.333, param3:Number = 1, param4:Number = 5000) : void
      {
         ...
         _near = param3;
         _far = param4;
         _loc5_ = Math.PI / 180 * _fov * 0.5;
         _tang = Math.tan(_loc5_);
         _nh = _near * _tang;
         _nw = _nh * _ratio;
         _fh = _far * _tang;
         _fw = _fh * _ratio;
         _loc6_ = Math.atan(_tang * _ratio);
      ...
      public function sphereInFrustum(param1:DisplayObject3D, param2:BoundingSphere) : int
      {
         ...
         _loc3_ = param2.radius;
         _loc8_ = INSIDE;
         _loc9_ = this.transform;
         _loc10_ = param1.world.n14 - _loc9_.n14;
         _loc11_ = param1.world.n24 - _loc9_.n24;
         _loc12_ = param1.world.n34 - _loc9_.n34;
